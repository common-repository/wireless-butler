...
class Wireless_Butler_Admin_Customer_Recommendation_Plan extends WP_List_Table {
	...
	/**
	 * Recommendation list Column name
	 */
	...
	function column_default( $item, $column_name ) {
        //FloatColumns
        $floatColumns = ['UploadedPlanCosts', 'CheapeastPlanCosts', 'CostForThisPlan', 'HostPlanCharge', 'Line1AccessCharge', 'Line2AccessCharge', 'Line3AccessCharge', 'Line4AccessCharge', 'Line5AccessCharge', 'TabletOrMHSLineAccessCharge', 'WearableLineAccessCharge', 'Line1AccessAutoPayCredit', 'Line2AccessAutoPayCredit', 'Line3AccessAutoPayCredit', 'Line4AccessAutoPayCredit', 'Line1SeniorCredit', 'Line2SeniorCredit', 'Line3SeniorCredit', 'Line4SeniorCredit', 'Line1SpecialWorkerCredit', 'Line2SpecialWorkerCredit', 'Line3SpecialWorkerCredit', 'Line4SpecialWorkerCredit', 'OverageAmount', '5gAccessCharge', 'MusicServicesValue', 'MovieTVServicesValue', 'SubsidizedFee'];
